...
class WeatherDetails_State extends State<WeatherDetails> {
  ...
  //late String url="https://api.openweathermap.org/data/2.5/weather?q=${widget.myCity}&appid=37234c0dc03a125fd544cfc5a9f05b5f&units=metric%27;";



  //static get myCity => null;

 /* void _getWeatherData(){

    http.get(Uri.parse(url))
        .then((data){
      weatherData=jsonDecode(data.body);
      ...
      setState(() {
        ...
        temp=weatherData["weather"][0]["main"];
         deg= weatherData["main"]["feels_like"];
      });
    })
        .catchError((err){
      print('error');
